...
for V in spacelist
    ...
    @timedtestset "Factorizations with symmetry: $Istr" verbose = true begin
        ...
        @testset "QR decomposition" begin
            for T in eltypes,
                t in (curand(T, W, W), curand(T, W, W)', curand(T, W, V1), curand(T, V1, W)',
        ...
        @testset "Polar decomposition" begin
            ...
            @testset for T in eltypes,
                t in (curand(T, W, W), curand(T, W, W)', curand(T, V1, W), curand(T, W, V1)',
                      CuDiagonalTensorMap(curand(T, reduceddim(V1)), V1),
                     )
        ...
        @testset "SVD" begin
            for T in eltypes,
                t in (curand(T, W, W), curand(T, W, W)',
        ...
        @testset "truncated SVD" begin
            for T in eltypes,
                t in (curandn(T, W, W), curandn(T, W, W)',
