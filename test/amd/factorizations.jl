const AMDGPUExt = Base.get_extension(TensorKit, :TensorKitAMDGPUAExt)
...
for V in spacelist
    ...
    @timedtestset "Factorizations with symmetry: $Istr" verbose = true begin
        ...
        @testset "QR decomposition" begin
            for T in eltypes,
                t in (rocrand(T, W, W), rocrand(T, W, W)', rocrand(T, W, V1), rocrand(T, V1, W)',
        ...
        @testset "Polar decomposition" begin
            ...
            @testset for T in eltypes,
                t in (rocrand(T, W, W), rocrand(T, W, W)', rocrand(T, V1, W), rocrand(T, W, V1)',
                      ROCDiagonalTensorMap(rocrand(T, reduceddim(V1)), V1),
                     )
        ...
        @testset "truncated SVD" begin
            for T in eltypes,
                t in (rocrandn(T, W, W), rocrandn(T, W, W)',
                      rocrandn(T, W, V1), rocrandn(T, V1, W),
                      rocrandn(T, W, V1)', rocrandn(T, V1, W)',
                      ROCDiagonalTensorMap(rocrandn(T, reduceddim(V1)), V1))
