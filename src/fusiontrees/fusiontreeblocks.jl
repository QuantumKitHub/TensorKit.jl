...
function braid(src::FusionTreeBlock{I, N, 0}, p::NTuple{N, Int}, levels::NTuple{N, Int}) where {I, N}
...
function braid(src::FusionTreeBlock{I}, p::Index2Tuple{N₁, N₂}, levels::Index2Tuple) where {I, N₁, N₂}
